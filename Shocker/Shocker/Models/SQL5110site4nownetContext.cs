...
{
    public partial class SQL5110site4nownetContext : DbContext
    {
        public SQL5110site4nownetContext()
        {
        }

        public SQL5110site4nownetContext(DbContextOptions<SQL5110site4nownetContext> options)
            : base(options)
        {
        }
